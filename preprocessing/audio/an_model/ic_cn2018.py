""" Nuclei of the auditory brainstem model provided by Verhulst et al. (2018).

This script is downloaded from https://github.com/HearingTechnology/Verhulstetal2018Model.

Reference
---------
Verhulst, S., Altoè, A., & Vasilkov, V., (2018). Computational modeling of the human auditory periphery: Auditory-nerve
responses, evoked potentials and hearing loss. Hearing research 364 (1-12). doi:10.1016/j.heares.2017.12.018
